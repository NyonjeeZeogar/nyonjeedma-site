    ...
    try {
      ...
      if (result.ok) {
        toast({
          ...
          description: "A real human will get back to you within 24 hours.",
        });
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-10">
          <div className="space-y-8">
            <div>
              <p className="font-inter font-semibold text-foreground mb-5">
                How we work
              </p>
              <div className="space-y-5">
                {[
                  ...
                  {
                    icon: Mail,
                    label: "Real responses",
                    value: "Every message is read by a real person.",
                  },
                  {
                    icon: Clock,
                    label: "Within 24 hours",
                    value: "We respect your time as much as our own.",
                  },
                ].map((item) => (
            ...
            <div className="bg-secondary text-secondary-foreground rounded-2xl p-6">
              <p className="font-inter text-sm text-secondary-foreground/70 italic leading-relaxed">
                "You don't need to have it all figured out. Just reach out —
                we'll figure it out together."
              </p>
              <p className="font-inter text-xs font-semibold text-primary mt-4">
                — Nyonjee, Founder
              </p>
            </div>
          </div>
          ...
          >
            <div>
              <h3 className="font-inter font-bold text-xl text-foreground mb-1">
